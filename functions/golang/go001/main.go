...
func Handler(ctx context.Context, params *Params) (*Result, error) {
	// 日志功能
	application.GetLogger(ctx).Infof("%s 函数开始执行本地12页面123", time.Now().Format("2006-01-02 15:04:05.999"))
	application.GetLogger(ctx).Infof("%s 函数开始执行本地12页面本地", time.Now().Format("2006-01-02 15:04:05.999"))
